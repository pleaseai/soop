import type { CodeEntity, LanguageConfig, ParseResult, SupportedLanguage } from '@pleaseai/soop-utils/ast/types'
import { describe, expect, it } from 'vitest'

describe('AST Types', () => {
  describe('imports', () => {
    it('should import types from ast/types', async () => {
      const module = await import('@pleaseai/soop-utils/ast/types')
